...
\item[-] Design and develop the next generation graph database LIquid:
...
\item[-] Leading the traffic migration project: migrate client traffic to the frontend API seemlessly
...
\item[-] Led the frontend API project: launched the only external RESTful API used by all clients with ACL, quota and monitoring features
